      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full flex flex-wrap gap-1 mb-8 bg-muted/30 border-2 border-border p-2 rounded-lg h-auto justify-start">
            <TabsTrigger 
              value="overview" 
              className="flex items-center gap-2 border border-border bg-muted/50 hover:bg-muted/80 data-[state=active]:border-2 data-[state=active]:border-primary data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-lg rounded-md transition-all px-3 py-2 text-sm whitespace-nowrap font-medium"
            >
